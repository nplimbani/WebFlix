...
public class MovieAdpater extends RecyclerView.Adapter<MovieAdpater.viewHolder> {
    ...
    public MovieAdpater(Context mContext, ArrayList<VideoModelClass> movie_arrayList) {
    ...
    @Override
    public MovieAdpater.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(MovieAdpater.viewHolder holder, final int position) {

...
public class K4Fragment extends Fragment {
    ...
    public K4Fragment(Context mContext) {
    ...
    private void callAPI() {
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,AppConstatnt.d3_k4_api+"k4_video", null,new Response.Listener<JSONObject>() {
            @Override

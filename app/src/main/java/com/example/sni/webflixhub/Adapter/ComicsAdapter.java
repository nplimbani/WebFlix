...
public class ComicsAdapter  extends RecyclerView.Adapter<ComicsAdapter.viewHolder> {
    ...
    public ComicsAdapter(Context mContext, ArrayList<VideoModelClass> comics_arrayList) {
        this.mContext = mContext;
        this.arrayList = comics_arrayList;
    ...
    public ComicsAdapter.viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ComicsAdapter.viewHolder vh=new ComicsAdapter.viewHolder(view);
    ...
    @Override
    public void onBindViewHolder(ComicsAdapter.viewHolder holder, final int position) {
